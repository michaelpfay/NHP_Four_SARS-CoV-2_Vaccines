---
title: "CoP SAP 6.2 Appendix"
author: "Allyson Mateja, Michael Fay"
...
<!-- To renumber the Tables for the Apppendix, I put each Table number 
     explicitly within the title. I needed to add the line 
     \usepackage{caption} to the reformat_paragraph.tex file
...
# 6.2 Appendix  Correlations of Virus-Specific Antibodies and Viral Load by Sex


We recalculate some of the Tables from CoP SAP 6.2 by sex.
...
No scatter plots will be done by sex, only Tables. 
-->
...
## Virus-Specific Antibodies by Viral Load
...
This section  will not be done by sex. 
 -->
